                                ...
                                <div class="card bg-transparent no-shadow mb-0">
                                    <div class="card-body bg-transparent px-0">
                                        ...
                                        <small class="h4 text-muted">
                                            <?php echo date("F", strtotime(date("Y-m-d H:i:s"))) . " " . date("d, Y H:i:s");
                                            ?>
                                        </small>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <h3 class="card-text"><span class="h1">
                                                        <?php echo $result1[0]["positif"]; ?>
                                                    </span> Orang</h3>
                                            </div>
                                            <div class="col-auto">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $row["nama_kabupaten_kota"]; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $row["suspek"]; ?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <?php echo $row["dirawat"]; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $row["meninggal"]; ?>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                        $count++;
